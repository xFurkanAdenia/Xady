...
export default class WebPosModule extends Xady.Module {
    ...
    onEnable(): void {
        ...
        this.#posManager = new PosManager(posConfig);
        ...
        webApi.registerView(navPath, async (req: any, ctx: any) => {
            ...
            const buf = this.getResource("resources/views/pos.html");
